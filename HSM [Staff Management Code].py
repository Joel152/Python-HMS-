...
def add_staff():
    ...
    if not name or not login_name or not department:
        messagebox.showwarning("Input Error", "Please fill all required fields.")
        return

    query = "INSERT INTO Staff (name, login_name, department, primary_role, additional_roles) VALUES (%s, %s, %s, %s, %s)"
    values = (name, login_name, department, primary_role, additional_roles)
